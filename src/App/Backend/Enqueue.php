		...
		foreach (
			[
				[
					...
					'media'   => 'all',
					'source'  => plugins_url( '/assets/public/css/backend.css', DEKODE_GUTENBERG_BLOCKS_PLUGIN_FILE ), // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
		...
		foreach (
			[
				[
					...
					'in_footer' => true,
					'source'    => plugins_url( '/assets/public/js/backend.js', DEKODE_GUTENBERG_BLOCKS_PLUGIN_FILE ), // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					'version'   => $this->plugin->version(),
				],
			] as $js ) {
