...
namespace DekodeGutenbergBlocks\App\Frontend;
 ...
 * Class Enqueue
 *
 * @package DekodeGutenbergBlocks\App\Frontend
 * @since 1.0.0
 */
		...
		foreach (
			[
				[
					...
					'media'   => 'all',
					'source'  => plugins_url( '/assets/public/css/frontend.css', DEKODE_GUTENBERG_BLOCKS_PLUGIN_FILE ), // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
		...
		foreach (
			[
				[
					...
					'in_footer' => true,
					'source'    => plugins_url( '/assets/public/js/frontend.js', DEKODE_GUTENBERG_BLOCKS_PLUGIN_FILE ), // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					'version'   => $this->plugin->version(),
				],
			] as $js ) {
