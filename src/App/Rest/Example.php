...
namespace DekodeGutenbergBlocks\App\Rest;
 ...
 * Class Example
 *
 * @package DekodeGutenbergBlocks\App\Rest
 * @since 1.0.0
 */
	...
	public function addCustomField() {
		register_rest_field(
			...
			[
				...
				'schema'          => [
					'description' => __( 'Text field demo of Post type', 'dekode-gutenberg-blocks' ),
					'type'        => 'string',
				],
			]
		);
	...
	public function updateTextField( string $value, \WP_Post $post, string $key ): \WP_Error {
		...
		if ( false === $post_id ) {
			return new \WP_Error(
				...
				\__( 'Failed to update post views.', 'dekode-gutenberg-blocks' ),
				[ 'status' => 500 ]
			);
		}
