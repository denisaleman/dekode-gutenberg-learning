...
use DekodeGutenbergBlocks\Common\Traits\Singleton;
...
final class Plugin {
	...
	public function data(): array {
		$plugin_data = apply_filters( 'dekode_gutenberg_blocks_plugin_data', [
		...
		return array_merge(
			apply_filters( 'dekode_gutenberg_blocks_plugin_meta_data',
				get_file_data( DEKODE_GUTENBERG_BLOCKS_PLUGIN_FILE, // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					[
						'name'         => 'Plugin Name',
						'uri'          => 'Plugin URI',
