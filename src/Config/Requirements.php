...
final class Requirements extends Base {
	...
	public function specifications(): array {
		return apply_filters( 'dekode_gutenberg_blocks_plugin_requirements', [
		...
		foreach (
			[
				...
				[
					...
					'title'   => __( 'Invalid PHP version', 'dekode-gutenberg-blocks' ),
					'message' => sprintf( /* translators: %1$1s: required php version, %2$2s: current php version */
						__( 'You must be using PHP %1$1s or greater. You are currently using PHP %2$2s.', 'dekode-gutenberg-blocks' ),
				...
				[
					...
					'title'   => __( 'Invalid WordPress version', 'dekode-gutenberg-blocks' ),
					'message' => sprintf( /* translators: %1$1s: required wordpress version, %2$2s: current wordpress version */
						__( 'You must be using WordPress %1$1s or greater. You are currently using WordPress %2$2s.', 'dekode-gutenberg-blocks' ),
