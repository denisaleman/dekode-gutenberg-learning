...
namespace DekodeGutenbergBlocks\Integrations\Widget;
 ...
 * Class HTML_Widget
 *
 * @package DekodeGutenbergBlocks\Integrations\Widget
 */
class HTML_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = [
			...
			'description'                 => __( 'Displays HTML code with syntax highlighting.', 'dekode-gutenberg-blocks' ),
			'customize_selective_refresh' => true,
		];
		$control_ops = [];
		parent::__construct( 'dekode-gutenberg-blocks', __( 'HTML Test Widget', 'dekode-gutenberg-blocks' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @since 0.1.0
		 */
		$content = apply_filters( 'dekode_gutenberg_blocks_html_widget_content', $content, $instance, $this );
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'content' ) ); ?>" class="screen-reader-text"><?php esc_html_e( 'Content:', 'dekode-gutenberg-blocks' ); ?></label>
